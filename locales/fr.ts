export default {
  ...
  "hero.title": "Simplifiez vos transactions financières",
  "hero.subtitle":
  ...
  "solutions.help.cta": "Contactez-nous",
  "solutions.cta.title": "Prêt à transformer votre système de paiement ?",
  "solutions.cta.description":
    "Rejoignez les entreprises qui font confiance à AvadaPay pour leurs solutions de paiement en ligne.",
  ...
  "testimonials.subtitle":
    "Découvrez pourquoi les entreprises font confiance à AvadaPay pour leurs solutions de paiement",

  // Contact Section
  "contact.title": "Prêt à",
  "contact.title2": "simplifier vos paiements",
  "contact.subtitle":
  ...
  footer: {
    ...
    copyright: "© {year} AvadaPay. Tous droits réservés.",
    social: {
      facebook: "Facebook",
      instagram: "Instagram",
      twitter: "Twitter",
